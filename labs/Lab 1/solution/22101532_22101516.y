...
%token IF ELSE FOR WHILE DO BREAK INT CHAR FLOAT DOUBLE VOID RETURN SWITCH CASE DEFAULT CONTINUE GOTO PRINTF PRINTLN CONST_INT CONST_FLOAT ADDOP MULOP INCOP DECOP RELOP ASSIGNOP LOGICOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD COMMA COLON SEMICOLON ID
...
statement : var_declaration
	...
	| PRINTLN LPAREN ID RPAREN SEMICOLON
	{
		...
		$$ = new symbol_info($1->getname()+"("+$3->getname()+");","statement");
	}
